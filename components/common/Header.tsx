...
const Header = () => {
  ...
  return (
    ...
    >
      <Container>
        <div className=" px-4  flex flex-col xl:flex-row xl:items-center xl:justify-between">
          <div className="flex gap-x-6 items-center justify-between w-full">
            ...
            <ul
              className={cn(
                ...
                "  hidden xl:flex flex-col items-center w-full bg-transparent  xl:flex-row xl:w-max xl:gap-x-8 gap-y-5"
              )}
            >
